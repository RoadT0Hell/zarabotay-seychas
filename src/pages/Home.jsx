...
const PARTNERS = [
  { icon: '🏦', name: 'Т-Банк', desc: 'Дебетовые и кредитные карты', slug: 'tbank' },
  { icon: '🏛️', name: 'СберБанк', desc: 'Кредиты и вклады', slug: 'sber' },
  { icon: '🎰', name: 'Fonbet', desc: 'Букмекерская контора', slug: 'fonbet' },
  { icon: '📊', name: 'БК Леон', desc: 'Спортивные ставки', slug: 'leon' },
  { icon: '💳', name: 'МФО', desc: 'Микрозаймы онлайн', slug: 'mfo' },
  { icon: '📈', name: 'Брокеры', desc: 'Инвестиционные платформы', slug: 'brokers' },
  { icon: '🪙', name: 'Крипто', desc: 'Обменники и биржи', slug: 'crypto' },
  { icon: '🎮', name: 'Казино', desc: 'Лицензированные операторы', slug: 'casino' },
]
...
export default function Home() {
  ...
  const handleCta = () => window.open(TG_CHANNEL, '_blank')
  const handleTgChannel = () => window.open(TG_CHANNEL, '_blank')
